...
namespace SmartSchool_webApi.Data
{
 ...
 public DataContext(DbContextOptions<DataContext> options) : base (options) { }        
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Professor>()//Criada tabela professor 
                .HasData(new List<Professor>(){
                    new Professor(1, "Lauro"), //Dados que vão ser salvos na tabela
            ...
            builder.Entity<Disciplina>()//Criada tabela disciplina
                .HasData(new List<Disciplina>{
                    new Disciplina(1, "Matemática", 1),//Dados que vão ser salvos na tabela
            ...
            builder.Entity<Aluno>()//Criado tabela Aluno
                .HasData(new List<Aluno>(){
                    new Aluno(1, "Marta", "Kent", "33225555"),//Dados que vão ser salvos na tabela
            ...
            builder.Entity<AlunoDisciplina>()//Criado tabela AlunoDisciplina
                .HasData(new List<AlunoDisciplina>() {
                    new AlunoDisciplina() {AlunoId = 1, DisciplinaId = 2 },//Dados que vão ser salvos na tabela
