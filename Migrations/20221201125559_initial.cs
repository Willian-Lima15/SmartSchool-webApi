    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Alunos",
                columns: new[] { "Id", "Nome", "Phone", "Sobrenome" },
                values: new object[] { 1, "Kent", "33225555", "Marta" });

            migrationBuilder.InsertData(
                table: "Alunos",
                columns: new[] { "Id", "Nome", "Phone", "Sobrenome" },
                values: new object[] { 2, "Isabela", "3354288", "Paula" });

            migrationBuilder.InsertData(
                table: "Alunos",
                columns: new[] { "Id", "Nome", "Phone", "Sobrenome" },
                values: new object[] { 3, "Antonia", "55668899", "Laura" });

            migrationBuilder.InsertData(
                table: "Alunos",
                columns: new[] { "Id", "Nome", "Phone", "Sobrenome" },
                values: new object[] { 4, "Maria", "6565659", "Luiza" });

            migrationBuilder.InsertData(
                table: "Alunos",
                columns: new[] { "Id", "Nome", "Phone", "Sobrenome" },
                values: new object[] { 5, "Machado", "565685415", "Lucas" });

            migrationBuilder.InsertData(
                table: "Alunos",
                columns: new[] { "Id", "Nome", "Phone", "Sobrenome" },
                values: new object[] { 6, "Alvares", "456454545", "Pedro" });

            migrationBuilder.InsertData(
                table: "Alunos",
                columns: new[] { "Id", "Nome", "Phone", "Sobrenome" },
                values: new object[] { 7, "José", "9874512", "Paulo" });
